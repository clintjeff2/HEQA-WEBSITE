...
const plans = [
  {
    ...
    currency: "",
    period: "Forever free",
    description: "Get started and explore past questions with basic access.",
    features: [
      { text: "Browse past questions online", included: true },
      { text: "View basic answers (no detailed solutions)", included: true },
      { text: "Ad-supported experience", included: true },
      { text: "Requires internet connection", included: true },
      { text: "Offline downloads & study", included: false },
      { text: "Detailed step-by-step solutions", included: false },
      { text: "Ad-free experience", included: false },
      { text: "PDF paper downloads", included: false },
    ],
  ...
  },
  {
    ...
    currency: "FCFA",
    period: "/week",
    description: "Perfect for quick exam crunch sessions.",
    features: [
      { text: "Access to ALL past questions", included: true },
      { text: "Detailed step-by-step expert solutions", included: true },
      { text: "Offline download & study anywhere", included: true },
      { text: "Completely ad-free experience", included: true },
      { text: "PDF paper downloads", included: true },
      { text: "Full analytics & progress tracking", included: true },
      { text: "Full offline practice & search", included: true },
  ...
  },
  {
    ...
    currency: "FCFA",
    period: "/month",
    description: "Our most popular plan. Best value for consistent study.",
    features: [
      { text: "Everything in Weekly, plus:", included: true },
  ...
  },
  {
    ...
    currency: "FCFA",
    period: "/year",
    yearlyPrice: "Save 65% vs monthly",
    description: "Best deal. Lock in a full year of unlimited access.",
    features: [
    ...
    buttonText: "Go Yearly — Best Deal",
    popular: false,
...
function PricingCard({ plan, index }) {
  ...
  return (
    ...
    >
      {/* Glossy overlay */}
      <div
        className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-white/0 via-white/40 dark:via-white/10 to-white/0 opacity-0 hover:opacity-100 transition-opacity duration-500 pointer-events-none"
      ...
      <div className="mb-8" style={{ transform: "translateZ(20px)" }}>
        <div
          className={`w-12 h-12 rounded-xl ${plan.popular ? "bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400" : "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400"} flex items-center justify-center mb-4`}
        >
          {plan.icon}
        </div>
      ...
      {/* Features */}
      <ul
        className="space-y-3.5 mb-10 flex-grow"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-5 text-lg text-slate-600 dark:text-slate-400">
            Start free, upgrade when you're ready. No hidden fees, just pure
            academic value. Pay with Mobile Money (MTN, Orange).
          </p>
        </motion.div>

        {/* Cards */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-start perspective-[1200px]">
