          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex justify-center items-center gap-2.5 bg-white text-primary-700 hover:bg-blue-50 px-8 py-4 rounded-full text-base font-bold transition-all shadow-xl shadow-black/10 group"
              >
                {/* Google Play icon */}
              ...
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex justify-center items-center gap-2.5 bg-white/10 hover:bg-white/20 text-white border border-white/25 px-8 py-4 rounded-full text-base font-semibold transition-all backdrop-blur-sm group"
              >
                {/* Apple icon */}
